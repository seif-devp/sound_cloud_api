...
class LoginScreen extends StatelessWidget{
      ...
      child: Scaffold(
        body: Container(
          ...
          decoration: const BoxDecoration(
            // تدرج لوني يعطي نفس تأثير الخلفية الفضائية المظلمة
            gradient: LinearGradient(
              begin: Alignment.topCenter,
              end: Alignment.bottomCenter,
              colors: [Color(0xFF130C27), Color(0xFF1B1437), Color(0xFF18102C)],
            ),
          ),
          child: SafeArea(
            child: Padding(
                          ...
                          builder: (context, state) {
                            ...
                            return _SocialButton(
                              ...
                              onTap: () {
                                ...
                                context.read<LoginScreenCubit>().loginfailure();
                              },
                            );
                          },
                        ),
  ...
  // أيكونة جوجل بسيطة عشان الكود يشتغل من غير باكدجات خارجية للصور
  Widget _buildGoogleIcon() {
    return Container(
      ...
      child: Icon(
        ...
        color: const Color.fromARGB(255, 0, 0, 0), // لون جوجل الأحمر
        size: 20,
      ),
    );
  }
